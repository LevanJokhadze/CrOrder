    ...
    <>
      ...
      >
        <div className="d-flex flex-column mb-2 mt-1">
          ...
          />
          {errors.name && (
            <p className="text-danger small pt-1">Company name is required</p>
          )}
        </div>
        ...
        <div className="d-flex flex-column mt-1 mb-2">
          ...
          />
          {errors.vat_number && (
            <p className="text-danger small pt-1">VAT number is required</p>
          )}
        </div>
        ...
        <div className="d-flex flex-column mt-1 mb-2">
          ...
          />
          {errors.address && (
            <p className="text-danger small pt-1">Address is required</p>
          )}
        </div>
            ...
            <div key={field.id} className="d-flex flex-row gap-1 align-items-center mb-1">
              {index !== fields.length - 1 ? (
                <>
                  <input
                    type="text"
                    className="h-40 w-55 text-center f-medium bankname bg-form darkblue border-0 bg-transparent pointer-none"
        ...
        <div className="d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center flex-row">
            <input type="checkbox" id="rememberMe" className="me-2 checkbox" />
