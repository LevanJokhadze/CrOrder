import logo from "../../assets/images/transpeed-logo.png";
          ...
          <div className="d-flex justify-content-between align-items-start pb-4">
            <div className="d-flex flex-column align-items-start">
              <div className=" d-flex flex-row align-items-center">
                ...
                <Link to="/">
                <h2 className=" f-bold h2 ms-1 mb-0">TranSpeed</h2>
                </Link>
              </div>
              <div>
                {" "}
                <ul className="f-light font-md mt-38">
                  ...
                  <li className="mt-3">info@transpeed.com</li>
                </ul>
              </div>
            </div>
        ...
        >
          <div className="d-flex flex-row align-items-center justify-content-between">
            <div className="font-md f-light d-flex flex-row align-items-center">
              <span className="me-2 h4 mb-0"> &copy; </span> 2024 TranSpeed Inc.
            </div>
